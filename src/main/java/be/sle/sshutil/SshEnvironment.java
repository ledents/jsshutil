...
public class SshEnvironment {
  ...
  public SshEnvironment() throws SshException {
    this(DEF_SSH_USERNAME, DEFAULT_IDENTITY_FILENAME, NO_PASSPHRASE);
  }

  @SuppressWarnings("unused")
  public SshEnvironment(byte[] passphrase) throws SshException {
    this(DEF_SSH_USERNAME, DEFAULT_IDENTITY_FILENAME, passphrase);
  }

  @SuppressWarnings("unused")
  public SshEnvironment(String defaultUsername, byte[] passphrase) throws SshException {
    this(defaultUsername, DEFAULT_IDENTITY_FILENAME, passphrase);
  }
  public SshEnvironment(String defaultUsername, String identityKeyFilename, byte[] passphrase) throws SshException {
    this.id = nextId();
  ...
  public SshSession openSession(String server) throws SshException {
      return new SshSession(this, server, defaultUsername);
  }

  @SuppressWarnings("unused")
  public SshSession openSession(String server, String remoteUsername) throws SshException {
  ...
  @SuppressWarnings("unused")
  public SshEnvironment loadDiscoveredIdentity() throws SshException {
  ...
  public SshEnvironment loadIdentity(String identityFileName, byte[] passphrase) throws SshException {
    return loadIdentity(SSH_CFG_PATH.resolve(identityFileName), passphrase);
  }

  public SshEnvironment loadIdentity(Path path) throws SshException {
    return loadIdentity(path, null);
  }
  public SshEnvironment loadIdentity(Path path, byte[] passphrase) throws SshException {
